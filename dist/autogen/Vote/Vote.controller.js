...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve multiple Votes' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], VoteController.prototype, "getMany", null);
__decorate([
    (0, crud_1.Override)('getOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve a single Vote' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], VoteController.prototype, "get", null);
__decorate([
    (0, crud_1.Override)('createOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Create a single Vote' }),
    (0, swagger_1.ApiBody)({
        type: Vote_dto_1.VoteCreate,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Vote_dto_1.Vote]),
    __metadata("design:returntype", void 0)
], VoteController.prototype, "create", null);
__decorate([
    (0, crud_1.Override)('createManyBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Create multipleVotes' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], VoteController.prototype, "createMany", null);
__decorate([
    (0, crud_1.Override)('updateOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a single Vote' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Vote_dto_1.Vote]),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Replace a single Vote' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __param(1, (0, crud_1.ParsedBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Vote_dto_1.Vote]),
    __metadata("design:returntype", void 0)
], VoteController.prototype, "replace", null);
__decorate([
    (0, crud_1.Override)('deleteOneBase'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a single Vote' }),
    __param(0, (0, crud_1.ParsedRequest)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
exports.VoteController = VoteController = __decorate([
    (0, crud_1.Crud)({
        model: {
            type: Vote_dto_1.Vote,
        },
        dto: {
            create: Vote_dto_1.VoteCreate,
            update: Vote_dto_1.Vote,
            replace: Vote_dto_1.Vote,
        },
        query: {
            limit: 5,
            alwaysPaginate: true,
